    ...
    public partial class AddDatabaseTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestQuestionsByUsers", x => new { x.ApplicationUserId, x.TestQuestionId });
                    table.ForeignKey(
                        name: "FK_TestQuestionsByUsers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestQuestionsByUsers_TestQuestions_TestQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestQuestionsByUsers_TestQuestionId",
                table: "TestQuestionsByUsers",
